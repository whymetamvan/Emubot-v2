    ...
    async execute(interaction) {
        ...
        const embed7 = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '**/dice**', value: 'サイコロを振る', inline: true },
                { name: '**/search-gif**', value: 'GIF検索', inline: true },
                { name: '**/google-search**', value: 'Google検索', inline: true },
                { name: '**/image-to-link**', value: '画像をURLに変換', inline: true }
            )
            .setColor(0xf8b4cb);
