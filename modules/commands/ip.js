    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setColor('#f8b4cb')
                .setTimestamp()
                .setFooter({ text: 'Emubot | ip lookup', iconURL:'https://png.pngtree.com/png-clipart/20230804/original/pngtree-ip-address-icon-www-push-net-vector-picture-image_9562164.png'})
