  ...
  async execute(interaction) {
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setColor('#f8b4cb')
        .setTimestamp()
        .setFooter({ text: 'Emubot | remove', iconURL:'https://play-lh.googleusercontent.com/4kF2IUQxdLs86iAVsmnHA1B34uO-dvtszKM8qzscc1InZb-2_JI0WANyOiWiV3qyNg=w240-h480-rw' })
